...
@TeleOp(name="Modern Tele op JUST DRIVE", group="Iterative Opmode")
public class ModernTeleOpJustDrive extends OpMode {
    DcMotor leftFront;
    DcMotor rightFront;
    DcMotor leftBack;
    DcMotor rightBack;
...
//        twist.setPosition(y);
    ...
    public void loop() {
        ...
        float fl = drive - strafe + turn; //drive - strafe + turn;
        float fr = drive - strafe - turn;
        float bl = drive + strafe + turn; // drive + strafe + turn;
...
////
       ...
       // foundationLeft.setPosition(x); //   :(
        ...
        //put blockServo code here
        if (gamepad2.right_trigger>0){
            blockServo.setPosition(.25);
        }
...
//            y=1;
//        }
//        if(gamepad2.left_stick_x<0&&!(y<=-1)){  //flick left
//            y=-1;
//        }
//////
//        twist.setPosition(y);
