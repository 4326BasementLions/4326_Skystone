...
@Autonomous(name="RED - TrueCameraBlockMachine",group="Iterative Opmode")

public class RedCameraBlockMachine extends OpMode {
    DcMotor leftFront;
    DcMotor rightFront;
    DcMotor leftBack;
    DcMotor rightBack;
    ...
    DigitalChannel touchSensor; //touch sensor
    ...
    final float CAMERA_FORWARD_DISPLACEMENT  = 4.0f * mmPerInch;   // eg: Camera is 4 Inches in front of robot center - subject to change
    final float CAMERA_VERTICAL_DISPLACEMENT = 8.0f * mmPerInch;   // eg: Camera is 8 Inches above ground - subject to change
    final float CAMERA_LEFT_DISPLACEMENT     = 0;     // eg: Camera is ON the robot's center line - subject to change
    ...
    public void init() {
        ...
        skystone = hardwareMap.servo.get("block");
        ...
        firstStep = new driveState(22, .5, motors, "forward");
        firstTurn = new GyroTurnCWByPID(90,.5, motors, imu);
        goforth = new driveState(22,.5,motors,"forward");
        goback = new driveState(22, .5, motors, "backward");
        ...
        park = new ColorSenseStopState(motors, colorSensor, "red", .5, "forward");

        faceBlock.setNextState(grabbbbbbbbbbb);
        grabbbbbbbbbbb.setNextState(goBusterst);
        goBusterst.setNextState(facebridge);
        facebridge.setNextState(park);
