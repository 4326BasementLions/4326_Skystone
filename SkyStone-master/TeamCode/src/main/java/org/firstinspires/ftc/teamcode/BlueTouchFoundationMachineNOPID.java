...
@Autonomous(name = "BLUE - TrueFoundation NOPID 1.7", group = "Iterative Opmode")

public class BlueTouchFoundationMachineNOPID extends OpMode {
    DcMotor leftFront;
    DcMotor rightFront;
    DcMotor leftBack;
    DcMotor rightBack;
 ...
 buttonDriveState approach;
    ...
    public void init() {
        ...
        lineUP  = new driveState(20, .5, motors, "forward");
        ...
        turnLeft = new driveState(45, .6 , motors, "turnLeft");
