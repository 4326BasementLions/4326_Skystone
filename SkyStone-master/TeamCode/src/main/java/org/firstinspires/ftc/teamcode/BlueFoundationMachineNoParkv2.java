...
@Autonomous(name="Blue foundation2 no park 1.8", group="Iterative Opmode")
public class BlueFoundationMachineNoParkv2 extends OpMode
{
    //test comment!ahs
    DcMotor leftFront;
    DcMotor rightFront;
...
//
        ...
        strafeIntoBuildingZone = new driveState(60, 1, motors, "left");
        pushFoundation = new driveState(25 , .8, motors, "forward");
        parkUnderBridge = new ColorSenseStopState(motors, colorSensor, "blue", .5, "backward"); //parks
