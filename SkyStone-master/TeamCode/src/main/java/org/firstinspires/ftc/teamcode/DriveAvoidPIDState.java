...
public class DriveAvoidPIDState implements StateMachine.State {
    DcMotor leftFront;                                    //////////////////////
    DcMotor rightFront;                                  ///////////////////////   :)
    DcMotor leftBack;                                     /////////////////////
    DcMotor rightBack;                                     //////////////////
    ...
    public DriveAvoidPIDState(int power, int time, ArrayList<DcMotor> motor, BNO055IMU imu_state){
        Power = power;
        Time = time;
        imu = imu_state;
    ...
    //ok time to work out rotate with time
