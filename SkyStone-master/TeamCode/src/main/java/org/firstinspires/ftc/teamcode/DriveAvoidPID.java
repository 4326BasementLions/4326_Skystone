...
@Autonomous(name="pid test", group="Exercises")
//@Disabled
public class DriveAvoidPID extends LinearOpMode
{
    ...
    double                  globalAngle, power = .50, correction, strafeCorrection;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        // Set PID proportional value to start reducing power at about 50 degrees of rotation. was .005
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("4 left", -power+correction);
            telemetry.addData("5 right", -power-correction);
            telemetry.addData("6 getAngle", getAngle());
            ...
            if (aButton || bButton)
            {
                ...
                if (aButton) rotate(-90, power);//rotating method

                if(bButton) {
                    strafeCorrection = pidDrive.performPID(getAngle());
                    pidDrive.setSetpoint(0);
                    pidDrive.setOutputRange(0, power);
                    pidDrive.setInputRange(-90, 90);
                    pidDrive.enable();
